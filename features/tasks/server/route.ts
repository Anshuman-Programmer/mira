...
const app = new Hono()
  ...
  .post(
    ...
    async (c) => {
      ...
      const higthestPositionTask = await databases.listDocuments(
        DATABASE_ID,
        TASKS_ID,
        [
      ...
      const newPosition =
        higthestPositionTask.documents.length > 0
          ? higthestPositionTask.documents[0].position + 1000
          : 1000;
