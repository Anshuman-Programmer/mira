...
import { useDeteteProject } from "../api/use-delete-project";
...
export const EditProjectForm = ({
  ...
  const { mutate: deleteProject, isPending: isPendingdPleteProject } =
    useDeteteProject();
          ...
          <Button
            ...
            onClick={
              onCancel
                ...
                : () =>
                    router.push(
                      `/workspaces/${initialValues.$worksapceId}/projects/${initialValues.$id}`
                    )
            }
          >
                      ...
                      <div className="flex items-center gap-x-5">
                        ...
                        <div className="flex flex-col">
                          ...
                          <input
                            ...
                            disabled={isPending || isPendingdPleteProject}
                          />
                          {field.value ? (
                            <Button
                              size={"xs"}
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardHeader className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              Delete a project is irreversible and will remove all associated
              data
            </p>
            <DottedSeparator className="py-7" />
            <Button
